  ...
  <body>
    <div class="page-content">
      ...
      <div class="container main-container">
        ...
        <div align="center" class="mx-auto text-center">
          ...
          <p><img src="{{base_url}}/static/megaphone.svg" class="svg-megaphone"> Send feedback by email to <a href="mailto:helpdesk@library.caltech.edu">helpdesk@library.caltech.edu</a> or the <a href="{{feedback_url}}">web form</a>.</p>
        </div>
