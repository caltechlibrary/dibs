  ...
  <body>
    <div class="page-content">
      ...
      <div class="container main-container">
        ...
        <div align="center" class="mx-auto text-center w-75">
          <p><i class="fas fa-question-circle fa-2x" style="vertical-align: middle"></i> <span style="vertical-align: middle">View the <a target="_blank" href="https://caltechlibrary.github.io/dibs/">help documentation</a> to learn more about DIBS and its use.</span></p>

          <p><img src="{{base_url}}/static/megaphone.svg" height="30rem"> Give us feedback via email to <a href="mailto:helpdesk@library.caltech.edu">helpdesk@library.caltech.edu</a> or the <a href="{{feedback_url}}">web form</a>.</p>
        </div>
