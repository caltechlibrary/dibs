  ...
  <body>
    <div class="d-flex align-items-center min-vh-100 my-5">
      <div class="container text-center">
        <img src="missing.jpg" class="rounded img-fluid" style="max-width: 500px" width="80%"
             title="Photo by Rebecca Minjarez. Taken in the Sherman Fairchild Library in January, 2021."
